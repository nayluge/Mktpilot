...
var App = function() {
    ...
    var uiInit = function() {
        ...
        $('.input-datepicker-first').datepicker({beforeShowDay : isFirstDayOfMonth, weekStart: 1}).on('changeDate', function(e){ $(this).datepicker('hide'); });
        $('.input-datepicker-last').datepicker({beforeShowDay : isLastDayOfMonth, weekStart: 1}).on('changeDate', function(e){ $(this).datepicker('hide'); });
